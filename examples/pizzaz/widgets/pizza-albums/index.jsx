...
import { useDisplayMode, useMaxHeight, useWidgetProps } from "fastapps";
...
function App() {
  ...
  const featuredTopping = props?.pizzaTopping ?? "Margherita";
  ...
  return (
    ...
    >
      <div className="absolute top-2 left-4 z-10 text-xs font-semibold text-black/60">
...
export default function PizzaAlbumsWidget() {
  return <App />;
}
